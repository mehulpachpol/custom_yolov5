...
def run(
    ...
    (project / 'labels' if save_txt else save_dir).mkdir(parents=True, exist_ok=True)  # make dir
    ...
    if save_txt or save_img:
        s = f"\n{len(list(project.glob('labels/*.txt')))} labels saved to {project / 'labels'}" if save_txt else ''
